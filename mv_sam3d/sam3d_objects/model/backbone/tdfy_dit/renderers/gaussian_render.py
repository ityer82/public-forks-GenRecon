        ...
        self.rendering_options = edict(
            {
                ...
                "ssaa": 1,
                "bg_color": "random",
                # 'inria' (diff_gaussian_rasterization) is the reference backend but is an
                # optional dependency not installed by default; fall back to 'gsplat'
                # (installed via requirements.inference.txt) when it isn't available.
                "backend": "inria" if _HAS_INRIA_BACKEND else "gsplat",
            }
        )
