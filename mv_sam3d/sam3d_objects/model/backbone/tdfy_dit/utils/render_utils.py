...
from ..renderers.gaussian_render import _HAS_INRIA_BACKEND
_DEFAULT_GAUSSIAN_BACKEND = "inria" if _HAS_INRIA_BACKEND else "gsplat"
...
def render_frames(
    ...
    **kwargs,
    ...
    if isinstance(sample, Octree):
        ...
        renderer.rendering_options.backend = options.get("backend", _DEFAULT_GAUSSIAN_BACKEND)
