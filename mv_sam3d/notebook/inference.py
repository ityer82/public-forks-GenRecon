...
# Only derive CUDA_HOME from a conda env if we're actually in one; leave
# whatever CUDA_HOME is already set (e.g. by a uv/non-conda environment)
# untouched otherwise, instead of hard-requiring CONDA_PREFIX to exist.
...
try:
    ...
    # kaolin is only needed for the notebook turntable visualizer, not for
    # headless inference; don't hard-require it just to import this module.
    IpyTurntableVisualizer = None
    Camera = CameraExtrinsics = PinholeIntrinsics = None
import builtins
